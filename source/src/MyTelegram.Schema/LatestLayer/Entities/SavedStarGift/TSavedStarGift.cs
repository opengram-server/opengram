...
public sealed class TSavedStarGift : ISavedStarGift
{
    ...
    public void ComputeFlag()
    {
        ...
        if (MsgId != null) { Flags = Flags.SetBit(3); }
        if (SavedId != null) { Flags = Flags.SetBit(11); }
        if (ConvertStars != null) { Flags = Flags.SetBit(4); }
        if (UpgradeStars != null) { Flags = Flags.SetBit(6); }
        if (CanExportAt != null) { Flags = Flags.SetBit(7); }
        if (TransferStars != null) { Flags = Flags.SetBit(8); }
        if (CanTransferAt != null) { Flags = Flags.SetBit(13); }
        if (CanResellAt != null) { Flags = Flags.SetBit(14); }
        if (CollectionId != null) { Flags = Flags.SetBit(15); }
