...
public sealed class TConfig : IConfig
{
    ...
    ///<summary>
    /// Whether star gifts are enabled
    /// See <a href="https://corefork.telegram.org/type/true" />
    ///</summary>
    public bool StargiftsEnabled { get; set; }
    ...
    public void ComputeFlag()
    {
        ...
        if (StargiftsEnabled) { Flags = Flags.SetBit(23); }
    }
    ...
    public void Serialize(IBufferWriter<byte> writer)
    {
        ...
        if (Flags.IsBitSet(23)) { writer.Write(StargiftsEnabled); }
    }
    ...
    public void Deserialize(ref ReadOnlyMemory<byte> buffer)
    {
        ...
        if (Flags.IsBitSet(23)) { StargiftsEnabled = true; }
    }
}