...
public sealed class TStickerSet : IStickerSet
{
    ...
    ///<summary>
    /// Is this an animated stickerset
    /// See <a href="https://corefork.telegram.org/type/true" />
    ///</summary>
    public bool Animated { get; set; }

    ///<summary>
    /// Is this a video stickerset
    /// See <a href="https://corefork.telegram.org/type/true" />
    ///</summary>
    ...
    public void ComputeFlag()
    {
        ...
        if (Animated) { Flags = Flags.SetBit(5); }
        if (Videos) { Flags = Flags.SetBit(6); }
    ...
    public void Deserialize(ref ReadOnlyMemory<byte> buffer)
    {
        ...
        if (Flags.IsBitSet(5)) { Animated = true; }
        if (Flags.IsBitSet(6)) { Videos = true; }
