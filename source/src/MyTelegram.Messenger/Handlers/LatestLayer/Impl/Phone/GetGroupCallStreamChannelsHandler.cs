    ...
    Phone.IGetGroupCallStreamChannelsHandler
{
    ...
    {
        // Stub implementation - RTMP streaming channels
        return Task.FromResult<MyTelegram.Schema.Phone.IGroupCallStreamChannels>(
            new MyTelegram.Schema.Phone.TGroupCallStreamChannels
            {
                Channels = new TVector<IGroupCallStreamChannel>()
            });
    }
}
