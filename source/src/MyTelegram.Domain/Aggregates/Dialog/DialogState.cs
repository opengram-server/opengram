...
public class DialogState : AggregateState<DialogAggregate, DialogId, DialogState>,
    ...
    IApply<DialogHistoryTTLUpdatedEvent>
{
    ...
    public void Apply(DialogHistoryTTLUpdatedEvent aggregateEvent)
    {
        // TTL is stored in DialogReadModel, no state change needed here
    }
